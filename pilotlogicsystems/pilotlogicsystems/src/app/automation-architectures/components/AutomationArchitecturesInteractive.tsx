      ...
      <section className="relative py-20 px-6 lg:px-12 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
            ...
            <span className="text-sm font-semibold text-primary">Automation Architectures</span>
          </div>
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Explore how intelligent automation transforms operations across different sectors. See the exact flow from input to outcome.
          </p>
        </div>
      </section>
